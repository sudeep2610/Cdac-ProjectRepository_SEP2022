        ...
        <div className="form-inline">
          <div className="input-group mb-2 mr-sm-2">
            ...
            <select
              ...
              required
            >
              <option value="Where from ?" onClick={this.handleInput}>
                Where from ?
              </option>
              ...
              <option value="Goa" onClick={this.handleInput}>
                Goa
              </option>
              <option value="Pune" onClick={this.handleInput}>
                Pune
              </option>
              <option value="Jaipur" onClick={this.handleInput}>
                Jaipur
              </option>
              <option value="Bangalore" onClick={this.handleInput}>
                Bangalore
              </option>
              <option value="Cochin" onClick={this.handleInput}>
                Cochin
              </option>
              <option value="Ahmadabad" onClick={this.handleInput}>
                Ahmadabad
              </option>
            </select>
          </div>
          ...
          <div className="input-group mb-2 mr-sm-2">
            <select
              ...
              required
            >
              <option value="Where to ?" onClick={this.handleInput}>
                Where to ?
              </option>
              <option value="Chennai" onClick={this.handleInput}>
                Chennai
